  ...
  for ( let i=0 ; i<numOfRow.value;i++){                                           
    if(i==0){
      ...
      for(let j=0; j<numOfColm.value ; j++){
        ...
        headCell.style.borderWidth=borderWidth.value+'px'
        row.append(headCell)
      ...
      for(let j=0; j<numOfColm.value; j++){
        ...
        bodyCell.style.borderWidth=borderWidth.value+'px'                    
      ...
      tableBody.append(row);        
        ...
        for(let j=0; j<numOfColm.value; j++){
          ...
          footerCell.style.borderWidth=borderWidth.value+'px'                    
...
const copyFunction=(element)=> {
  ...
  fakeTextArea.value = element.textContent; 
